...
@section('title', 'Tambah Pengguna - BCSXPSS')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.users.store') }}" method="POST">
                ...
                <div class="row mb-3">
                    <label for="password_confirmation" class="col-md-3 col-form-label">Konfirmasi Password <span class="text-danger">*</span></label>
                    <div class="col-md-9">
