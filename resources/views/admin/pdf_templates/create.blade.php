...
@section('title', 'Buat Template PDF - BCSXPSS')

@section('page-title', 'Buat Template PDF Baru')
...
<div class="container-fluid animate-fade-in">
    <div class="row mb-4">
        <div class="col-md-8">
            <h1 class="h3 mb-3">Buat Template PDF Baru</h1>
            <p class="text-muted">
                Buat template PDF baru untuk tiket pertandingan. Template akan digunakan untuk menghasilkan PDF tiket yang dapat diunduh oleh pengguna.
            </p>
        </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.pdf-templates.store') }}" method="POST">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    @enderror
                    <div class="form-text">Masukkan nama yang mudah diidentifikasi untuk template ini.</div>
                </div>
                
                <div class="mb-3">
                    <label for="html_content" class="form-label">Konten HTML</label>
                    <textarea class="form-control code-editor @error('html_content') is-invalid @enderror" id="html_content" name="html_content" rows="20" required>{{ old('html_content', App\Models\PdfTemplate::getDefaultHtml()) }}</textarea>
                    @error('html_content')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
